...
def login():
    ...
    try :
        ...
        favoris_list = None    
    #2
    return render_template("login.html",favoris_list = favoris_list, show_loader=False)
...
def check_login() :
    ...
    return render_template('login.html', show_loader=False)
...
def check_signin():
    ...
    return render_template('inscription.html', show_loader=False)
...
def delete() :
    ...
    return render_template('delete.html', show_loader=False)
...
def searchCPU():
    ...
    return render_template("searchCPU.html", marques=marques,filtres = ['',''],favoris_list = favoris_list, show_loader=False)
...
def check_filtre():
    ...
    # marque dispo 
    marques = requetes_marques_cpu()
    return render_template('searchCPU.html', resultats=resultats if resultats else None, filtres = [filtre], max_items=max_items,marques=marques, favoris_list = favoris_list , show_loader=True) 
...
def searchGPU():
    ...
    return render_template("searchGPU.html",filtres =['',''] ,marques=marques ,favoris_list =favoris_list, show_loader=False)
...
def check_filtre_gpu():
    ...
    # marques dispo
    marques = requetes_marques_gpu()
    return render_template('searchGPU.html', resultats_gpu = resultats_gpu if resultats_gpu else None,filtres =[filtre],max_items=max_items,marques = marques,favoris_list=favoris_list, show_loader=True)
