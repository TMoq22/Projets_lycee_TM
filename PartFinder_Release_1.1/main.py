...
def check_login() :
    if request.method == 'POST':
        ...
        if user:
            ...
            return render_template('login.html', show_loader=False,message =("Connexion réussie!","vert"))
          
    return render_template('login.html', show_loader=False,message =("Pseudo ou mot de passe incorrect","rouge"))
